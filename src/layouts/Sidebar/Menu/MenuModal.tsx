...
const MenuModal: React.FC<MenuModalProps> = ({ open, handleCloseMenu }) => {
    ...
    return (
        <div
            ref={modalRef}
            className="absolute left-0 z-10 overflow-hidden transition-all bg-white bottom-full filter-menu rounded-2xl w-menu"
        >
            <motion.div
            ...
            >
                <div className="w-1/2 p-2 main-menu">
                    ...
                    <div
                        className="flex items-center p-4 text-sm transition-opacity duration-100 rounded-lg cursor-pointer hover:bg-lightHover ease-hover"
                        onClick={() => handleToggleMenu(appearanceMenuHeight)}
                    >
                        <IoSunnyOutline className="w-5 h-5" />
                        <span className="ml-3">Switch appearance</span>
                    </div>
                    <div className="flex items-center p-4 text-sm transition-opacity duration-100 rounded-lg cursor-pointer hover:bg-lightHover ease-hover">
                ...
                <div className="w-1/2 appearance-menu">
                    <div className="flex items-center p-4 border-b border-solid border-separator">
                        <div
                    ...
                    <div className="p-2">
                        <div
                            className="flex items-center justify-between p-4 text-sm transition-opacity duration-100 rounded-lg cursor-pointer hover:bg-lightHover ease-hover"
