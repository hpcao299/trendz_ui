    ...
    return (
        <>
            <div className="w-[350px] border border-solid border-separator py-2.5 px-10 flex flex-col items-center h-max mb-2.5">
                ...
                <button className="flex items-center bg-transparent outline-none text-[#385185] text-sm font-semibold mt-6 mb-5">
                    <span className="inline-block w-4 h-4 mr-2 bg-facebook-icon-primary"></span>{' '}
                    {t('login-with-facebook')}
                </button>
                <Link href={config.routes.passwordReset} className="text-xs text-link mb-2.5">
                    {t('forgot-password')}
                </Link>
            </div>
